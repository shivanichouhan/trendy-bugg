      	 ...
      	 <thead>
				...
				<tbody>
				 ...
				 <?php
					...
					{$i++;
					$cat=$obj->fetchById($row['category'],"category","id");
					$scat=$obj->fetchById($row['sub_category'],"sub_category","id");
					$sub_topic=$obj->fetchById($row['sub_topic'],"sub_topic","id");
					$brand=$obj->fetchById($row['brand'],"brand","id");
			 ?>
             <tr>
