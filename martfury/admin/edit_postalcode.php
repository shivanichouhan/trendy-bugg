...
$cate=$obj->fetchById($_GET['id'], "postalcode","id");?>
      ...
      <div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">  Postal Code</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="edit_postalcode_sub.php" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" value="<?php echo $cate['id'];?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">  Postal Code</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="postalcode" placeholder="  Postal Code " value="<?php echo $cate['postalcode'];?>">
                </div>
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1"> SLA Days</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="sla_days" placeholder="  SLA Days" value="<?php echo $cate['sla_days'];?>">
                </div>
