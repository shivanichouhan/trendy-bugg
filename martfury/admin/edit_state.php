...
$cate=$obj->fetchById($_GET['id'], "state","id");?>
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="edit_state_sub.php" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" value="<?php echo $cate['id'];?>">
              <div class="box-body">
			  <div class="form-group">
                  <label for="exampleInputEmail1">Country Name</label>
                  <select class="form-control" id="exampleInputEmail1" name="country" placeholder="Country Name">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="state" placeholder="State Name" value="<?php echo $cate['state'];?>">
                </div>
