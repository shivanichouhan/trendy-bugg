<?php
 ...
 include"../include/session.php";
  $obj=new database();
   $project=$obj->fetchById(@$_SESSION['id'], "project","pro_id");
?> 
<!DOCTYPE html>
<html>
<head>
...
<?php include('sidebar.php');?>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
	<form action="location_sub.php" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
                <label>Start Date*</label>
                   <input type="date" class="form-control" name="sdate" placeholder="DD/MM/YYYY" required>
              </div>
              <!-- /.form-group -->
            ...
            <div class="col-md-6">
			   <div class="form-group">
                <label>location/Village*</label>
                   <input type="text" class="form-control" id="geocomplete" name="plocation"  required>
			  ...
			  <div class="form-group">
                ...
                <input type="text" class="form-control" name="ppost_code"  pattern="[0-9]{4,15}" title="Please Enter Correct Pincode" required>
              </div>
			  <div class="form-group">
                <label>End Date*</label>
                   <input type="date" class="form-control" name="edate" placeholder="DD/MM/YYYY" required>
              </div>
            </div>
            <!-- /.col -->
          </div>
 ...
 <script src="http://maps.googleapis.com/maps/api/js?sensor=false&amp;libraries=places"></script>
    ...
    <script>
      $(function(){
        ...
        var options = {
          map: ".map_canvas",
         location: "<?php echo $project['plocation'];?>"
