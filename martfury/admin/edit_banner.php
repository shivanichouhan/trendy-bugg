...
$content=$obj->fetchById($_GET['id'], "banner","id");?>
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="edit_banner_sub.php" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" value="<?php echo $content['id'];?>">
             <div class="box-body">
                 ...
                 <?php  $marchent_register=$obj->fetchDetailById(1,"marchent_register","status");
					...
					{
?>
                  <option <?php if($marchent['m_id']==$content['m_id']){  ?> selected="selected" <?php } ?>  value="<?php echo $marchent['m_id'];?>"><?php echo $marchent['seller_id'];?></option>
<?php }  } ?>
                  </select>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Link" name="link" value="<?php echo $content['link'];?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Descriptions</label>
				  <textarea class="form-control" id="editor1" name="content"><?php echo $content['descriptions'];?></textarea>
