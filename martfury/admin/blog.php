    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="blog_sub.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
			 ...
			 ?>
                <tr>
                  ...
                  <td><?php echo substr($row['content'],0,20);?></td>
                   <td class="center"><?php echo $row['icon'];?>
				   
				 </td>
                  <td class="center"><a class="btn btn-info" href="edit_blog.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><a class="btn btn-danger" href="delete.php?id=<?php echo $row['id'];?>&table=blog&field=id&page=blog" onClick="return confirm('Are you sure?');"> <i class="glyphicon glyphicon-trash icon-white"></i> Delete </a> </td>
                </tr>
             <?php }}?>  
			 </tbody>
			  <tfoot>
