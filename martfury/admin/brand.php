    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="brand_sub.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Image Size(143*72)</label>
 ...
 <tbody>
			 ...
			 ?>
              <tr>
                  ...
                  <td class="center"><a class="btn btn-info" href="edit_brand.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><a class="btn btn-danger" href="delete.php?id=<?php echo $row['id'];?>&table=brand&field=id&page=brand" onClick="return confirm('Are you sure?');"> <i class="glyphicon glyphicon-trash icon-white"></i> Delete </a> </td>
                </tr>
             <?php }}?> 
			 </tbody>
			  <tfoot>
