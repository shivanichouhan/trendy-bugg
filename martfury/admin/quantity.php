    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="quantity_sub.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
 ...
 <tbody>
			 ...
			 ?>
              <tr>
                  ...
                  <td class="center"><a class="btn btn-info" href="edit_quantity.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><a class="btn btn-danger" href="delete.php?id=<?php echo $row['id'];?>&table=quantity&field=id&page=quantity" onClick="return confirm('Are you sure?');"> <i class="glyphicon glyphicon-trash icon-white"></i> Delete </a> </td>
                </tr>
             <?php }}?> 
			 </tbody>
			  <tfoot>
